...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            >Unleash your creativity with AI. Turn your imagination into visual art in seconds - jsut type, and watch the magic happen.</motion.p>
            ...
            <motion.div className='flex flex-wrap justidy-center mt-16 gap-3'
            initial={{opacity: 0}}
            animate={{opacity: 1}}
            ...
            className='mt-2 text-neutral-600'>Generated Images form Imagify</motion.p>
